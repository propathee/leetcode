...
import com.leetcode.leetcode_103_Binary_Tree_Zigzag_Level_Order_Traversal_Medium.Solution103.TreeNode;
...
public class Solution103Tests {
    private Solution103 solution = Solution103.newSolution();

    @Test
    public void should_pass_1() {
        TreeNode root = makeTree(3,9,20,null,null,15,7);
        List<List<Integer>> levels = makeLevels("[3],[20,9],[15,7]");
        assertPass(levels, solution.zigzagLevelOrder(root));
    }
